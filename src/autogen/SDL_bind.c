/*
** Lua binding: SDL
** Generated automatically by tolua++-1.0.92 on 07/25/07 17:04:28.
*/
...
#include "sdllib.h"
       ...
       void * _SDL_memcpy (void *dst, const void *src, size_t len)
       {
       ...
       void * _SDL_revcpy (void *dst, const void *src, size_t len)
       {
       #if defined(__GNUC__) && defined(i386)
       ...
       SDL_bool _SDLNet_SocketReady(SDLNet_GenericSocket sock)
       {
           return SDLNet_SocketReady(sock);
       }
       SDL_bool _SDLNet_TCP_SocketReady(TCPsocket sock)
       {
           return SDLNet_SocketReady(sock);
       }
       SDL_bool _SDLNet_UDP_SocketReady(UDPsocket sock)
       {
           return SDLNet_SocketReady(sock);
       }
...
static int tolua_set_SDL_AudioSpec_callback(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->callback = ((void*)  tolua_touserdata(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_SDL_AudioCVT_buf(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->buf = ((void*)  tolua_touserdata(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_SDL_Cursor_mask(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->mask = ((void*)  tolua_touserdata(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_SDL_SDL_SDL_CreateCursor00(lua_State* tolua_S)
{
 ...
 {
  SDL_Cursor* tolua_ret = (SDL_Cursor*)  SDL_CreateCursor(data,mask,w,h,hot_x,hot_y);
...
static int tolua_set_SDL_SDL_SDL_Overlay_pixels(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"array indexing out of range.",NULL);
#endif
  self->pixels[tolua_index] = ((void*)  tolua_touserdata(tolua_S,3,0));
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_SDL_SDL_IMG_ReadXPMFromArray00(lua_State* tolua_S)
{
 ...
 {
  SDL_Surface* tolua_ret = (SDL_Surface*)  IMG_ReadXPMFromArray(xpm);
 tolua_pushusertype(tolua_S,(void*)tolua_ret,"SDL_Surface");
 }
 }
 return 1;
...
static int tolua_set_Mix_Chunk_abuf(lua_State* tolua_S)
{
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->abuf = ((void*)  tolua_touserdata(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_SDL_SDL_Mix_QuickLoad_WAV00(lua_State* tolua_S)
{
...
#endif
 {
  void* mem = ((void*)  tolua_touserdata(tolua_S,1,0));
 {
  Mix_Chunk* tolua_ret = (Mix_Chunk*)  Mix_QuickLoad_WAV(mem);
 tolua_pushusertype(tolua_S,(void*)tolua_ret,"Mix_Chunk");
 }
 }
 return 1;
...
static int tolua_SDL_SDL_Mix_QuickLoad_RAW00(lua_State* tolua_S)
{
 ...
 {
  Mix_Chunk* tolua_ret = (Mix_Chunk*)  Mix_QuickLoad_RAW(mem,len);
 tolua_pushusertype(tolua_S,(void*)tolua_ret,"Mix_Chunk");
 }
 }
 return 1;
...
static int tolua_SDL_SDL_SDLNet_AddSocket00(lua_State* tolua_S)
{
 ...
 {
  int tolua_ret = (int)  SDLNet_AddSocket(set,sock);
 tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
 }
 }
 return 1;
...
static int tolua_SDL_SDL_SDLNet_DelSocket00(lua_State* tolua_S)
{
...
#endif
 {
  ...
  struct _SDLNet_GenericSocket* sock = ((struct _SDLNet_GenericSocket*)  tolua_tousertype(tolua_S,2,0));
 {
  int tolua_ret = (int)  SDLNet_DelSocket(set,sock);
 tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
 }
 }
 return 1;
...
static int tolua_SDL_SDL_SDLNet_SocketReady00(lua_State* tolua_S)
{
 ...
 {
  SDL_bool tolua_ret = (SDL_bool)  _SDLNet_SocketReady(sock);
 tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
 }
 }
 return 1;
